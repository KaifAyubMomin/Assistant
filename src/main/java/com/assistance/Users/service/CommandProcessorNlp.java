...
public class CommandProcessorNlp {
    ...
    public UserInfoModel processCommand(MessageDTO messageDTO) {
        ...
        if (wordList.contains("set") && wordList.contains("as")) {
            ...
            String resultPart = parts[1] != null ? parts[1].trim() : ""; // Extract and trim the result part
            ...
            System.out.println("check here result part " + resultPart);
            ...
            String resultPart = commandPart; // This variable holds the command after the replacement
            ...
            resultPart = timeDetection.removeTimePhrases(resultPart);
            resultPart = resultPart.replaceAll("\\b(i am|i|you)\\b" , "You");
            userInfo.setResponse( resultPart.replace("i", "you")); // Set the resulting response from processing
        }
        ...
        userInfo.setCommandText(commandPart); // Set the full command text
